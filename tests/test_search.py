...
def test_amazon_search(page, search_terms):
    ...
    assert "/s" in page.url and "wireless+mouse" in page.url, f"Expected search results page, but got {page.url}"
...
def test_amazon_search_with_multiple_keywords(page, search_terms):
    ...
    #check search results page
    assert "/s" in page.url and "gaming+keyboard+rgb" in page.url, f"Expected search results page, but got {page.url}"
